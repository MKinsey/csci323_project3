                    ...
                    d3Service.d3().then(function(d3) {
                        ...
                        scope.render = function(data) {
                            ...
                            renderTimeout = $timeout(function() {
                                ...
                                var circleEnter = circle.enter().append("circle").call(scope.drag).on("mousedown", function(d) { d3.event.stopPropagation(); console.log("clicked", d); d3.selectAll("circle").style("fill", "black"); d3.select(this).style("fill", "orange"); prepareToDeselect = false; scope.$apply(function() { scope.currentBody = d; }) });
                                svg_c.on("mousedown",function() {prepareToDeselect = true});
                                svg_c.on("mouseup",function() {if(prepareToDeselect) {console.log("clicked");svg.selectAll("circle").style("fill", "black"); scope.$apply(function() { scope.currentBody = null; });}});
