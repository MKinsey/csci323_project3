                    ...
                    d3Service.d3().then(function(d3) {
                        ...
                        scope.render = function(data) {
                            ...
                            renderTimeout = $timeout(function() {
                                ...
                                circleEnter.on("mousedown", function(d) { d3.event.stopPropagation(); console.log("clicked", d); d3.selectAll("circle").style("opacity", "0.4"); d3.select(this).style("opacity", "1"); prepareToDeselect = false; scope.$apply(function() { scope.currentBody = d; }) });
                                circleEnter.on("touchstart", function(d) { d3.event.stopPropagation(); console.log("clicked", d); d3.selectAll("circle").style("opacity", "0.4"); d3.select(this).style("opacity", "1"); prepareToDeselect = false; scope.$apply(function() { scope.currentBody = d; }) });
