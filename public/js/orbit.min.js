            ...
            return {
                ...
                link: function(scope, ele, attrs) {
                    d3Service.d3().then(function(d3) {
                        ...
                        function updateViewport(scale, translate, alreadyApply) {
                            svg.attr("transform", "translate(" + translate + ") scale(" + scale +")");
                            if(!alreadyApply) {
                                scope.$apply(function() {
                                    scope.zoomFactor = scale;
                                    scope.translation = translate;
                                });
                            }
                        }

                        svg_c.call(window.zoom.scaleExtent([minZoom,maxZoom]).on("zoom", function() {
                                    updateViewport(d3.event.scale, d3.event.translate, false);
                                }));
                        ...
                        scope.$watch('bodies', function(newData) {
                            if(newData && newData.length != length) {
                        ...
                        scope.$watch('zoomFactor', function(newZoomFactor) {
                                ...
                                updateViewport(window.zoom.scale(), window.zoom.translate(), true);
                            }, true);
                        scope.$watch('translation', function(newTrans) {
